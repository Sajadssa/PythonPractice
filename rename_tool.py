...
def extract_from_pdf(pdf_path):
    ...
    try:
        with pdfplumber.open(pdf_path) as pdf:
            ...
            # Sequence Number - multiple patterns
            seq_num = None
            patterns = [
...
def process_directory(directory_path):
    ...
    for file_path in all_files:
        ...
        #SJSC-GGNRSP-EPWC-REWK-0001-G00
        if seq and rev:
...
def main():
    ...
    EXCEL_OUTPUT = r"D:\Sepher_Pasargad\works\Production\Production Operation Report\weekly\file_list.xlsx"
    ...
    if not results:
        ...
        print("- Files contain Sequence Number and Revision in header")
        print("- Libraries are installed: pip install pdfplumber python-docx openpyxl")
        return
